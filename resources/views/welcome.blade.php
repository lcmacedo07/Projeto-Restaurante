    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="Food-fair-toggle">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="#menu-list">lista de menu</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="section-header">
                                <h2 class="pricing-title">Nossa lista de menu em preços acessíveis</h2>
        ...
        <div class="container-fluid">
            <div class="row dis-table">
                <div class="col-xs-6 col-sm-6 dis-table-cell color-bg">
                    <h2 class="section-title">Reserva uma Mesa!</h2>
                </div>
                ...
                <div class="row">
                        ...
                        <form class="reservation-form" method="post" action="{{ route('reservation.reserve') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control reserve-form empty iconified" name="date_and_time" id="datetimepicker1" placeholder="&#xf017;  Tempo">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <textarea type="text" name="message" class="form-control reserve-form empty iconified" id="message" rows="3"  placeholder="  &#xf086;  Estamos Ouvindo"></textarea>
                                </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="opening-time">
                            <h3 class="opening-time-title">Horas</h3>
                            <p>Seg a Sex: 7:30 AM - 11:30 AM</p>
                            <p>Sáb & Dom: 8:00 AM - 9:00 AM</p>

                            <div class="launch">
                                    <h4>Almoço</h4>
                                <p>Seg a Sex: 12:00 PM - 5:00 PM</p>
                            </div>

                            <div class="dinner">
                                <h4>Jantar</h4>
                                <p>Seg a Sáb: 6:00 PM - 1:00 AM</p>
                                <p>Dom: 5:30 PM - 12:00 AM</p>
                            </div>
                        </div>
                    </div>
                </div>
